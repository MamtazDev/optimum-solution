...
const [derkMode, setDerkMode] = useState(false)
  ...
  const turnMode = mode => {
    if (  mode === 'light') {
      ...
      localStorage.setItem('modeStatus',  'dark');
    } else {
      props.changeMode('light');
      localStorage.setItem('modeStatus',  'light');
    }
  };
...
{/* <Tooltip title="Turn Dark/Light" placement="bottom">
                <IconButton className={classes.button} onClick={() => setDerkMode(true)}>
                  <i className="ion-ios-bulb-outline" />
                </IconButton>
              </Tooltip> */}
...
{/* 
              <Tooltip title="Turn Dark/Light" placement="bottom">
                <IconButton className={classes.button} onClick={() => turnModesetDerkMode(true)}>
                  <i className="ion-ios-bulb-outline" />
                </IconButton>
              </Tooltip> */}
